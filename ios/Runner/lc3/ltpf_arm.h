...
{
    static const int16_t __attribute__((aligned(4))) h[2*8*12] = {
...
static void arm_resample_16k_12k8(
    struct lc3_ltpf_hp50_state *hp50, const int16_t *x, int16_t *y, int n)
{
    static const int16_t __attribute__((aligned(4))) h[2*4*24] = {
...
static void arm_resample_32k_12k8(
    struct lc3_ltpf_hp50_state *hp50, const int16_t *x, int16_t *y, int n)
{
    static const int16_t __attribute__((aligned(4))) h[2*2*48] = {
...
static void arm_resample_24k_12k8(
    struct lc3_ltpf_hp50_state *hp50, const int16_t *x, int16_t *y, int n)
{
    static const int16_t __attribute__((aligned(4))) h[2*8*32] = {
...
static void arm_resample_48k_12k8(
    struct lc3_ltpf_hp50_state *hp50, const int16_t *x, int16_t *y, int n)
{
    static const int16_t __attribute__((aligned(4))) h[2*4*64] = {
